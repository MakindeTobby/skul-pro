...
const Footer = () => {
    return (
        <div className='w-full bg-white py-24 text-start'>
            <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
                <div className='col-span-2'>
                    ...
                    <div className='flex gap-4 py-4'>
                        <div className='p-4 bg-[#6D737A] rounded-xl'><FaFacebookF size={25} style={{ color: '#fff' }} /></div>
                        <div className='p-4 bg-[#6D737A] rounded-xl'><FaDribbble size={25} style={{ color: '#fff' }} /></div>
                        <div className='p-4 bg-[#6D737A] rounded-xl'><FaLinkedinIn size={25} style={{ color: '#fff' }} /></div>
                        <div className='p-4 bg-[#6D737A] rounded-xl'><FaInstagram size={25} style={{ color: '#fff' }} /></div>
                        <div className='p-4 bg-[#6D737A] rounded-xl'><FaBehance size={25} style={{ color: '#fff' }} /></div>
                ...
                <div className='max-[780px]:col-span-2'>
                    ...
                    <form className='py-4'>
                        ...
                        />
                        <button className='max-[780px]:w-full my-4 px-5 py-3 rounded-md bg-slate-800 text-white font-medium'>Subscribe Now</button>
